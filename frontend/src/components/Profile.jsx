...
const Profile = () => {
    ...
    return (
        <div className="flex flex-col items-center p-4 sm:p-6 w-full transition-colors duration-300">
            ...
            {loading ? (
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 p-8 w-full max-w-4xl text-center">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 p-8 w-full max-w-4xl transition-colors duration-300">
                    {showCropper && (
                        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
                            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-[90vw] max-w-xl p-4">
                                <div className="relative w-full h-[50vh] bg-gray-100 dark:bg-gray-700 rounded-lg overflow-hidden">
                                    <Cropper
                                        image={selectedSrc}
                                        crop={crop}
                                        zoom={zoom}
                                ...
                                <div className="flex items-center justify-between mt-4">
                                    ...
                                    <div className="space-x-2">
                                        <button onClick={handleCropCancel} className="px-4 py-2 rounded-lg bg-gray-200 dark:bg-gray-600 dark:text-gray-200">Cancel</button>
                    ...
                    <h1 className="text-4xl font-extrabold text-green-800 dark:text-green-400 mb-8 tracking-tight">My Profile Settings</h1>

                    <div className="flex flex-col md:flex-row items-center gap-8 pb-6 border-b border-gray-200 dark:border-gray-700 mb-6">
                        <div ref={avatarRef} className="relative w-full md:w-auto flex flex-col items-center">
                            <div className="rounded-full w-32 h-32 bg-green-100 dark:bg-green-900/30 flex items-center justify-center text-green-600 dark:text-green-400 border-4 border-green-300 dark:border-green-700 shadow-lg overflow-hidden">
                                {avatarUrl ? (
                            ...
                            <button
                                className="absolute bottom-0 right-0 p-2 bg-green-500 text-white rounded-full hover:bg-green-600 transition duration-150 shadow-md border-2 border-white dark:border-gray-800"
                            ...
                            {showAvatarMenu && (
                                <div className="absolute -bottom-16 right-0 bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 shadow-lg rounded-lg p-2 z-10 w-40">
                                    <button
                                        className="block w-full text-left px-3 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 rounded"
                                        onClick={() => { setShowAvatarMenu(false); handleAvatarClick(); }}
                                    >
                                        Upload Image
                                    </button>
                                    <button
                                        className="block w-full text-left px-3 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 rounded text-red-600 dark:text-red-400"
                        ...
                        <div className="text-center md:text-left">
                            <h2 className="text-3xl font-bold text-gray-800 dark:text-gray-100 mb-1">{name}</h2>
                            <p className="text-lg text-green-600 dark:text-green-400 font-medium mb-1 flex items-center justify-center md:justify-start gap-2">
                                <Mail size={16} />{email}
                            </p>
                            {phone && (
                                <p className="text-md text-gray-500 dark:text-gray-400 flex items-center justify-center md:justify-start gap-2">
                                    <Phone size={16} />{phone}
                                </p>
                            )}
                        </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="col-span-1">
                                ...
                                <input type="email" value={email} readOnly placeholder="your.email@example.com" className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-gray-400" />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <input value={phone} onChange={(e) => setPhone(e.target.value)} placeholder="e.g., +94771234567" className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100" />
                        </div>
                        ...
                        <div>
                            ...
                            <textarea rows="4" value={bio} onChange={(e) => setBio(e.target.value)} placeholder="Tell us a little bit about your role or yourself..." className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100" />
                        </div>
            ...
            {showPasswordModal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
                    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-[90vw] max-w-md p-6">
                        <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">Confirm Password</h2>
                        <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">Enter your current password to save profile changes.</p>
                        <input type="password" value={currentPassword} onChange={(e) => setCurrentPassword(e.target.value)} placeholder="Current password" className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 mb-4" disabled={isSaving} />
